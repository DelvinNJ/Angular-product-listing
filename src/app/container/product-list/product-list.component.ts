...
export class ProductListComponent {
  ...
  inStock = this.productList.filter(stock => stock.stock_availability === true).length
  outStock = this.productList.filter(stock => stock.stock_availability === false).length
